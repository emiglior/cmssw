...
GeometricDet::GeometricDet(DDFilteredView* fv, GeometricEnumType type)
  ...
  if (type_ == DetUnit) {
    ...
    bigPixelsx_ = (getString("BigPixels_X", *fv) == strue);
    bigPixelsy_ = (getString("BigPixels_Y", *fv) == strue);
...
GeometricDet::GeometricDet(cms::DDFilteredView* fv, GeometricEnumType type)
  ...
  if (type_ == DetUnit) {
    ...
    bigPixelsx_ = (fv->get<std::string_view>("BigPixels_X") == strue);
    bigPixelsy_ = (fv->get<std::string_view>("BigPixels_Y") == strue);
