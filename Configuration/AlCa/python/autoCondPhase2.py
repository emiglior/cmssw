...
allTags["LA"] = {
    ...
    'T33' : ( ','.join( [ 'SiPixelLorentzAngle_phase2_IT_v7.1.0_25x100_v1_mc' ,SiPixelLARecord,connectionString, "", "2023-01-17 20:00:00.000"] ), ),  #uH = 0.053/T (TBPX L2,L3,L4), uH=0.0/T (TBPX L1 TEPX+TFPX)
}
