#ifndef RecoLocalTracker_Phase2ITPixelRecHits_Phase2PixelCPEBase_H
#define RecoLocalTracker_Phase2ITPixelRecHits_Phase2PixelCPEBase_H 1

//-----------------------------------------------------------------------------
// \class        Phase2PixelCPEBase
...
class MagneticField;
class Phase2PixelCPEBase : public Phase2ITPixelClusterParameterEstimator 
{
 public:
  struct DetParam
  {
...
public:
  Phase2PixelCPEBase(edm::ParameterSet const& conf, const MagneticField * mag, const TrackerGeometry& geom, const TrackerTopology& ttopo,
  ...
  inline ReturnType getParameters(const Phase2ITPixelCluster & cl, 
				   const GeomDetUnit    & det ) const
    {
#ifdef EDM_ML_DEBUG
      nRecHitsTotal_++ ;
      //std::cout<<" in Phase2PixelCPEBase:localParameters(all) - "<<nRecHitsTotal_<<std::endl;  //dk
#endif 
      ...
      //std::cout<<" in Phase2PixelCPEBase:localParameters(all) - "<<lp.x()<<" "<<lp.y()<<std::endl;  //dk
      return tuple;
    }
				   ...
				   const LocalTrajectoryParameters & ltp ) const
  {
#ifdef EDM_ML_DEBUG
    nRecHitsTotal_++ ;
    //std::cout<<" in Phase2PixelCPEBase:localParameters(on track) - "<<nRecHitsTotal_<<std::endl;  //dk
#endif 
    ...
    //std::cout<<" in Phase2PixelCPEBase:localParameters(on track) - "<<lp.x()<<" "<<lp.y()<<std::endl;  //dk
    return tuple;
  } 
