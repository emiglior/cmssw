#ifndef RecoLocalTracker_Phase2PixelRecHits_Phase2PixelCPEBase_H
#define RecoLocalTracker_Phase2PixelRecHits_Phase2PixelCPEBase_H 1
...
class MagneticField;
class Phase2PixelCPEBase : public Phase2PixelClusterParameterEstimator 
{
 public:
  struct DetParam
  {
