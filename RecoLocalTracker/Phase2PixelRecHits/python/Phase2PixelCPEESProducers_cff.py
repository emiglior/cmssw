...
#
# from RecoLocalTracker.Phase2PixelRecHits.Phase2PixelCPEInitial_cfi import *
#
# 2. TrackingRechits using angles from tracks(EM 2016.05.17: Phase2PixelCPEParamError_cfi is not loading anything)
#
# from RecoLocalTracker.Phase2PixelRecHits.Phase2PixelCPEParmError_cfi import *
#
# 3. Template algorithm (EM 2016.05.17: skipped for the moment) 
#
# 4. Pixel Generic CPE
#
from RecoLocalTracker.Phase2PixelRecHits.Phase2PixelCPEGeneric_cfi import *
#
