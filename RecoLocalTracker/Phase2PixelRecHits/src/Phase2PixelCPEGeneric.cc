...
Phase2PixelCPEGeneric::Phase2PixelCPEGeneric(edm::ParameterSet const & conf, 
  ...
  if(MYDEBUG) {
    cout << "From Phase2PixelCPEGeneric::Phase2PixelCPEGeneric(...)" << endl;
...
Phase2PixelCPEGeneric::localPosition(DetParam const & theDetParam, ClusterParam & theClusterParamBase) const 
{
  ...
  //cout<<" in Phase2PixelCPEGeneric:localPosition - "<<endl; //dk
			 ...
			 ) const
{
  ...
  //cout<<" in Phase2PixelCPEGeneric:generic_position_formula - "<<endl; //dk
