...
def customise_Reco(process,pileup):
    ...
    process.load('RecoLocalTracker.Phase2PixelClusterizer.Phase2PixelClusterizer_cfi')
    ...
    process.load("RecoLocalTracker.Phase2PixelClusterizer.Phase2PixelClusterizer_cfi")
    process.phase2PixelClusters.src = cms.InputTag('simSiPixelDigis', "Pixel")
    process.phase2PixelClusters.MissCalibrate = cms.untracked.bool(False)
    process.load("RecoLocalTracker.Phase2PixelRecHits.Phase2PixelRecHits_cfi")
    process.phase2PixelRecHits.src = cms.InputTag("phase2PixelClusters")
